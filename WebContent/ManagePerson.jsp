...
<%
        ...
        <td>Телефоны:</td>        
         ...
         <td>
            ...
            %>
             <%=phone%> 
             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
             <a href="<%=request.getContextPath()%>/?action=editPhone&id=<%=phone%>">Редактировать</a>
             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
             <a href="<%=request.getContextPath()%>/?action=deletePhone&id=<%=phone%>">Удалить</a>             
             <br />
            <%
              }
            %>
    ...
    <tr>
    <td colspan="6" align="center"><a href="<%=request.getContextPath()%>/?">Вернуться к списку</a></td> 
    </tr>
